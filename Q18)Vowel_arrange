...
class sentences
{
    public static void main(String[] args) {
        ...
        System.out.print("Enter a sentence terminated by either ‘.’, ‘?’ or ‘!’: ");
...
/*
terminal output :
Enter a sentence terminated by either ‘.’, ‘?’ or ‘!’: HOW ARE YOU///
Invalid Input
...
Enter a sentence terminated by either ‘.’, ‘?’ or ‘!’: YOU MUST AIM TO BE A BETTER PERSON TOMORROW THAN YOU ARE TODAY.
